...
export const FluidParticlesBackground = ({
  ...
  useEffect(() => {
    ...
    // Create a local variable for the actual width to avoid issues with DPR scaling inside the animation loop
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-screen overflow-hidden bg-white dark:bg-black", 
        className,
      )}
    >
