...
const VisionaryForm = memo(function VisionaryForm() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12, flex: 1 }}>
      ...
      <a href="https://www.linkedin.com/company/lxwyerup" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 12, padding: '8px 16px', background: '#fff', color: '#1e40af', border: '1px solid #1e40af', borderRadius: 20, textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600, transition: 'all 0.3s' }} onMouseEnter={e => { e.currentTarget.style.background = '#1e40af'; e.currentTarget.style.color = '#fff'; }} onMouseLeave={e => { e.currentTarget.style.background = '#fff'; e.currentTarget.style.color = '#1e40af'; }}>
